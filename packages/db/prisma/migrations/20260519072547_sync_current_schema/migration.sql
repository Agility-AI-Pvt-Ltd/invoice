...
-- AlterTable
ALTER TABLE "Organization" ADD COLUMN     "upiId" TEXT;

-- AlterTable
ALTER TABLE "RecurringInvoice" ADD COLUMN     "discountTotal" DECIMAL(12,2) NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE "RecurringInvoiceItem" ADD COLUMN     "discount" DECIMAL(12,2) NOT NULL DEFAULT 0;
